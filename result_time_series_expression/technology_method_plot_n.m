...
for i = 1:length(data)
    ...
    for l = 2:size(plot_data,2)
        stat_v = [plot_data{2, l} plot_data{4, l} plot_data{6, l} plot_data{8, l} plot_data{10, l} plot_data{12, l} plot_data{14, l}];
        error_v = [plot_data{3, l} plot_data{5, l} plot_data{7, l} plot_data{9, l} plot_data{11, l} plot_data{13, l} plot_data{15, l}];
        y = [y; stat_v];
        e = [e; error_v];
    end
