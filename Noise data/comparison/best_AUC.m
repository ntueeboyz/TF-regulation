...
for i = 1:length(data)
    ...
    x = 1:6;
    bar(x,y, 0.3);
    bar(x, [y(1) nan nan nan nan nan], 0.3, 'FaceColor', [0 0.4470 0.7410]);
    hold on
    bar(x, [nan y(2) nan nan nan nan], 0.3, 'FaceColor', [0.8500 0.3250 0.0980]);
    hold on
    bar(x, [nan nan y(3) nan nan nan], 0.3, 'FaceColor', [0.9290 0.6940 0.1250]);
    hold on
    bar(x, [nan nan nan y(4) nan nan], 0.3, 'FaceColor', [0.4940 0.1840 0.5560]);
    hold on
    bar(x, [nan nan nan nan y(5) nan], 0.3, 'FaceColor', [0.4660 0.6740 0.1880]);
    hold on
    bar(x, [nan nan nan nan nan y(6)], 0.3, 'FaceColor', [0.6350 0.0780 0.1840]);
    hold on
