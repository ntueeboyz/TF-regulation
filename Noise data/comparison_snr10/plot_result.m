...
load THP1_single_cell_snr10_TSNI.mat

t_tsni_auc = statistic_result{2,5};

load THP1_single_cell_snr10_SINCERITIES.mat

t_sincerities_auc = statistic_result{2,5};

load THP1_single_cell_snr10_GRNVBEM.mat

t_grnvbem_auc = statistic_result{2,5};

%% simulated data 1

load insilico_size100_1_snr10.mat
...
load insilico_size100_1_snr10_TSNI.mat

s1_tsni_auc = statistic_result{2,5};

load insilico_size100_1_snr10_SINCERITIES.mat

s1_sincerities_auc = statistic_result{2,5};

load insilico_size100_1_snr10_GRNVBEM.mat

s1_grnvbem_auc = statistic_result{2,5};

%%

load insilico_size100_2_snr10.mat
...
load insilico_size100_2_snr10_TSNI.mat

s2_tsni_auc = statistic_result{2,5};

load insilico_size100_2_snr10_SINCERITIES.mat

s2_sincerities_auc = statistic_result{2,5};

load insilico_size100_2_snr10_GRNVBEM.mat
...
t = suptitle('Method comparison of SNR 10 data');
set(t,'FontSize',30);